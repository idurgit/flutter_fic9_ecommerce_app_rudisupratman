...
class _$AddAddressImpl implements _AddAddress {
  ...
  @override
  String toString() {
    return 'AddAddressEvent.addAddress(name: $name, address: $address, phone: $phone, provId: $provId, cityId: $cityId, subdistrictId: $subdistrictId, provinceName: $provinceName, cityName: $cityName, subdistrictName: $subdistrictName, postalCode: $postalCode, userId: $userId, isDefault: $isDefault)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return addAddress(name, address, phone, provId, cityId, subdistrictId,
        provinceName, cityName, subdistrictName, postalCode, userId, isDefault);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return addAddress?.call(name, address, phone, provId, cityId, subdistrictId,
        provinceName, cityName, subdistrictName, postalCode, userId, isDefault);
  }
